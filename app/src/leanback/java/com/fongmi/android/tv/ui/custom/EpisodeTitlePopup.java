...
public class EpisodeTitlePopup {
    ...
    private static MaterialTextView createTextView(Context context, CharSequence title) {
        ...
        textView.setPadding(ResUtil.dp2px(18), ResUtil.dp2px(12), ResUtil.dp2px(18), ResUtil.dp2px(12));
        textView.setMinWidth(ResUtil.dp2px(220));
        textView.setMaxWidth(Math.min(ResUtil.dp2px(560), (int) (ResUtil.getScreenWidth(context) * 0.72f)));
    ...
    private static void showAtAnchor(View anchor, View content, PopupWindow popup) {
        ...
        int maxWidth = Math.min(ResUtil.dp2px(560), screenWidth - margin * 2);
